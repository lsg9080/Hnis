...
clickCheckbox = function (e) {
    $(e).prev("input[type=checkbox][lay-skin=primary]").click();
    if ($(e).prev("input[type=checkbox][lay-skin=primary]").is(":checked")) {
        $(e).find("i").css({
            "background-color": "#65B36E",
            "border": "1px solid #65B36E"
        });
    } else {
        $(e).find("i").css({
    ...
    i.prototype.init = function (e) {
        ...
        i.prototype.tree = function (e, a) {//生成树
            ...
            layui.each(n, function(a, n) {
                /*var id = r.uuid();
                if(n.id.length == 0) n.id = id;//给每一个节点都设置id
                console.log(n.data);
                    ...
                    s = o(
                        [
                            ...
                            function() {
                                ...
                                var eleStr = i.check && i.check == "checkbox" ? '<input type="checkbox" lay-skin="primary" name="' + i.checkboxName + '" ' + ((n.checked && n.checked == true) ? 'checked="checked"' : "") + (n.checkboxValue ? ('value="' + n.checkboxValue + '"') : "") + 'data-parent-id="' + n.pid + '"' + 'id="' + n.id + '"' + (i.checkboxStyle ? (' style="' + i.checkboxStyle + '"') : "") : '';
                                if (eleStr.length > 0) {
                                    //给元素添加data-xxx属性
                                    if (n.data && Object.prototype.toString.call(n.data) == "[object Object]") {
                                    ...
                                    eleStr += ' />' + ((n.checked && n.checked == true) ? '<div class="layui-unselect layui-form-checkbox layui-form-checked" lay-skin="primary" onclick="clickCheckbox(this);"><i class="layui-icon" style="color:#fff;padding:0; margin:0;">&#xe605;</i></div>'
                                        : '<div class="layui-unselect layui-form-checkbox" lay-skin="primary" onclick="clickCheckbox(this);"><i class="layui-icon" style="color:#fff;padding:0; margin:0;">&#xe605;</i></div>');
                                }
        ...
        i.prototype.changed = function (e, o) {
            ...
            if (o.pid == undefined || o.pid == null) {
                e.children("input").on("change", function() {
                    ...
                    if (this.checked) {
                        childUl.find("input").next("div").find("i").css({
                            "background-color": "#65B36E",
                            "border": "1px solid #65B36E"
                        });
                    } else {
                ...
                e.children("input").on("change", function () {
                    ...
                    if (!this.checked) {
                        ...
                        r.parentsChecked($("input[id=" + o.pid + "]")[0], true);
                        o && $("input[id=" + o.pid + "]").next("div:first").find("i").css({
                            "background-color": "#65B36E",
                            "border": "1px solid #65B36E"
                        });
                        if (o.children && o.children.length > 0) {
        ...
        i.prototype.cancelParentsCheckboxCheck = function (ele) {
            ...
            if (bool && !hasOneChildrenInputCheck) {
                ...
                parentInput && $("input[id=" + parentInput.id + "]").next("div:first").find("i").css({
                    "background-color": "#fff",
                    "border": "1px solid #d2d2d2"
                });
            }
