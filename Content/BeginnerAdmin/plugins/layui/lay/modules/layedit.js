...
function (t) {
    ...
    s.prototype.build = function (t, i) {
        ...
        m = e(['<div class="' + r + '">', '<div class="layui-unselect layui-layedit-tool" lang="layui-tool">' + f + "</div>", '<div class="layui-layedit-iframe">', '<iframe id="' + u + '" name="' + u + '" textarea="' + t + '" frameborder="0"></iframe>', "</div>", "</div>"].join(""));
    ...
    var c = function (t, i, a) {
        ...
        function () {
            ...
            s = o.find("head"),
            c = e(["<style>", "*{margin: 0; padding: 0;}", "body{padding: 10px; line-height: 20px; overflow-x: hidden; word-wrap: break-word; font: 14px Helvetica Neue,Helvetica,PingFang SC,Microsoft YaHei,Tahoma,Arial,sans-serif; -webkit-box-sizing: border-box !important; -moz-box-sizing: border-box !important; box-sizing: border-box !important;}", "a{color:#01AAED; text-decoration:none;}a:hover{color:#c00}", "p{margin-bottom: 10px;}", "img{display: inline-block; border: none; vertical-align: middle;}", "pre{margin: 10px 0; padding: 10px; line-height: 20px; border: 1px solid #ddd; border-left-width: 6px; background-color: #F2F2F2; color: #333; font-family: Courier New; font-size: 12px;}", "#layui-body::-webkit-scrollbar-track{-webkit-box-shadow: #FFFFFF;background-color: #FFFFFF;border-radius: 10px;}","#layui-body::-webkit-scrollbar{width: 7px;background-color: #FFFFFF;}","#layui-body::-webkit-scrollbar-thumb{border-radius: 10px;background: #4478a9;}", "</style>"].join("")),
            u = o.find("body");
            s.append(c),
            u.attr("id", "layui-body"),
