...
layui.config({
    base: '/Content/BeginnerAdmin/plugins/lay/modules/',
    version: new Date().getTime()
}).use(['element', 'layer', 'navbar', 'tab','cookie'], function () {
    ...
    layer.open({
        ...
        success: function (layero, lockIndex) {
            ...
            layero.find('button#unlock').on('click', function () {
                ...
                var userName = $lockBox.find('input[id=lockName]').val();
