...
function Item2Score(t, els) {
    ...
    if (t == 2) { //原体重
        ...
        var sljx = $("input[type=checkbox][name=" + els.jschk + "]").is(":checked");
        if (sljx) {
            $(els.jstr).show();
        } else {
            $(els.jstr).hide();
...
function ScreeningScore(els) {
    ...
    if ($("#NeedSecondaryScreen").val() == "true" || IsInitialScreen == "0") {
        ...
        else if (error11 == 0 && $("input[type=checkbox][name=" + els.wtchk + "]").is(":checked")) {
            $(els.resultMsg).text("体重下降数据不完整，暂无法进行评分!");
            $(els.submit).val("false");
            ConfigoptionTr(els.actionTr, 0);
        } else if (error22 == 0 && $("input[type=checkbox][name=" + els.jschk + "]").is(":checked")) {
...
function CalculationScore(bmi, els) {
    ...
    if ($("input[type=checkbox][name=" + els.wtchk + "]").is(":checked")) { //如果体重有下降取分
        s2 = $(els.wttr).find("input[type=radio][name=" + els.xjrado + "]:checked").val() || 0;
    }
    if ($("input[type=checkbox][name=" + els.jschk + "]").is(":checked")) { //如果进食量有减少取分
    ...
    if (oldWeight > 0 && weight > 0) {
        ...
        if (pr > 0) {
            if (pr >= 5) { //减少百分之一才算体重下降
                $("input[type=checkbox][name=" + els.wtchk + "]").prop("checked", true);
               ...
               // $("input[type=checkbox][name=" + els.wtchk + "]").prop('disabled', true);
                ...
                $("input[type=checkbox][name=" + els.wtchk + "]").prop("checked", false);
                //$("input[type=checkbox][name=" + els.wtchk + "]").addClass("layui-disabled");
                //$("input[type=checkbox][name=" + els.wtchk + "]").prop('disabled', true);
                ...
                if (data.result) {
                    ...
                    if (t == 4) {
                        ...
                        if (bmi < 18.5 && bmi > 0) {
                            ...
                            $("input[type=radio][name=" + els.bmirdo + "][value=3]").prop("checked", true);
                            $("input[type=radio][name=" + els.bmirdo + "][value=0]").prop("checked", false);
                            fm.win_render('checkbox');
                            SetInitialScreenClass(els, IsInitialScreen);
                        } else {
                            $("input[type=checkbox][name=ChkInitialScreenA]").prop("checked", false);
                            $("input[type=radio][name=" + els.bmirdo + "][value=3]").prop("checked", false);
                            $("input[type=radio][name=" + els.bmirdo + "][value=0]").prop("checked", true);
                            fm.win_render('checkbox');
                            SetInitialScreenClass(els, IsInitialScreen);
                        }
                    }
